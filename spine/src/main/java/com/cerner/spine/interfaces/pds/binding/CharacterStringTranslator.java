 ...
 */
public class CharacterStringTranslator implements IAliasable, IMarshaller, IUnmarshaller
{
    ...
    public CharacterStringTranslator()
    {
        uri = null;
        index = 0;
        name = "value";
    ...
    public CharacterStringTranslator(String uri, int idx, String name)
    {
        this.uri = uri;
        this.index = idx;
        this.name = name;
    ...
    public Object unmarshal(Object obj, IUnmarshallingContext ictx) throws JiBXException
    {
        ...
        // see if the "nullFlavor" is present
        if(ctx.hasAttribute(null, NULL_FLAVOR_ATTRIBUTE))
        {
            ...
            // String nullFlavor = ctx.attributeText(null, NULL_FLAVOR_ATTRIBUTE);
            ctx.skipElement();
            return null;
        }
        ...
        // return the string value. this also places the parse at the end of the current element. 
        return ctx.parseContentText(uri, name);
    }
